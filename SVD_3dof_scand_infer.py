...
def main(args) :
    ...
    test_anno = os.path.join(split_root, "scand", "test", "traj_names.txt")
    ...
    for traj in tqdm(val_set) :
        ...
        for clip_start in clip_starts :
            ...
            for t in sample_indx:
                x_y = position_data[t]
                yaw = yaw_data[t]
                positions.append([x_y[0] / METRIC_WAYPOINT_SPACING_SCAND, x_y[1] / METRIC_WAYPOINT_SPACING_SCAND])
            ...
            for t in sample_indx[1:] :
                ...
                action_x_y = to_local_coords(x_y, init_x_y, init_yaw) / METRIC_WAYPOINT_SPACING_SCAND
...
if __name__ == "__main__" :
    ...
    parser.add_argument(
        "--data_root",
        default="data/scand/",
        help="Root directory containing SCAND trajectories.",
    )
