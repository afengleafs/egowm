...
def get_args_parser():
    ...
    parser.add_argument('--dataset_file', default='ytvos', help='Dataset name') #/mnt/efs/Anurag-data/mochi_pre_encoded/
    parser.add_argument('--T5_enc_path', type=str, default='/mnt/efs/Anurag-data/mochi_pre_encoded/txtT5')
    parser.add_argument('--coco_path', type=str, default='/mnt/efs/Anurag-data/mochi_pre_encoded/raw_data/COCO-rvos')
    parser.add_argument('--ytvos_path', type=str, default='/mnt/efs/Anurag-data/mochi_pre_encoded/raw_data/rvos')
    parser.add_argument('--refsav_path', type=str, default='/mnt/fsx/Anurag/ref_sav/')
    parser.add_argument('--sav_path', type=str, default='/mnt/fsx/Anurag/SA-V/')
    parser.add_argument('--davis_path', type=str, default='/workspace/data/raw_data/ref-davis')
    parser.add_argument('--a2d_path', type=str, default='/mnt/fsx-west/anurag/A2D-sentences-rvos/a2d-sentences')
    parser.add_argument('--jhmdb_path', type=str, default='/data/Dataset/jhmdb_sentences')
    parser.add_argument('--vspw_path', type=str, default='/mnt/fsx-west/anurag/VSPW_480p')
    ...
    parser.add_argument('--draw_init_point', action='store_true', help='whether visualize the init points/box during inference')
    ...
    parser.add_argument('--semi_online', action='store_true')
    parser.add_argument('--update_pos', action='store_true')
    parser.add_argument('--use_checkpoint_for_more_frames', action='store_true')
